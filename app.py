...
st.sidebar.checkbox("Show Follow-up Questions",
                    value=True, key="show_followup")
st.sidebar.button("Reset", on_click=lambda: set_question(
    ...
    if sql:
        if is_sql_valid_cached(sql=sql):
            if st.session_state.get("show_sql", True):
                ...
                assistant_message_sql.code(
                    sql, language="sql", line_numbers=True)
        else:
